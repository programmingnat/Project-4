...
//                // check in your actual production app.
//                if (!BaseGameUtils.verifySampleSetup(this, R.string.app_id)) {
//                    Log.w("MainActivity", "*** Warning: setup problems detected. Sign in may not work!");
//                }
//
//                // start the sign-in flow
...
//            case R.id.button_quick_game:
//                // user wants to play against a random opponent right now
//                Log.d("MainActivity","button_quick_game clicked");
//                startQuickGame();
//                break;
//            case R.id.button_click_me:
//                // (gameplay) user clicked the "click me" button
...
//    }
//    void startQuickGame() {
//        Log.d("MainActivity","Inside startQuickGame");
//        // quick-start a game with 1 randomly selected opponent
//        final int MIN_OPPONENTS = 1, MAX_OPPONENTS = 1;
//        Bundle autoMatchCriteria = RoomConfig.createAutoMatchCriteria(MIN_OPPONENTS,
//                MAX_OPPONENTS, 0);
//        Log.d("MainActivity", "created autoMatchCriteria");
//        RoomConfig.Builder rtmConfigBuilder = RoomConfig.builder(this);
//        rtmConfigBuilder.setMessageReceivedListener(this);
//        rtmConfigBuilder.setRoomStatusUpdateListener(this);
//        rtmConfigBuilder.setAutoMatchCriteria(autoMatchCriteria);
//        Log.d("MainActivity", "RoomConfig.Builder called--about to switch screens");
//        switchToScreen(R.id.screen_wait);
//        Log.d("MainActivity", "switchToScreen");
//        keepScreenOn();
//        Log.d("MainActivity", "keepScreenOn");
//        resetGameVars();
//        Log.d("MainActivity", "resetGameVars");
//        Games.RealTimeMultiplayer.create(mGoogleApiClient, rtmConfigBuilder.build());
//        Log.d("MainActivity", "Games.RealTimeMultiplayer");
//    }
//
//    @Override
...
//        Log.d("MainActivity", "onSignedInFailed");
//    }
//
//    @Override
//    public void onSignInSucceeded() {
//
//        Log.d("MainActivity", "onSignInSucceeded");
//
//
//
//    }
...
//    }
//
//    //===================SINGLE PLAYER GAME & GAME TUFF IN GENERAL===
//    // Start the gameplay phase of the game.
//    void startGame(boolean multiplayer) {
//        Log.d("MainActivity","inside startGame");
//        mMultiplayer = multiplayer;
//
//        updateScoreDisplay();
//        Log.d("MainActivity", "updateScoreDisplay just called");
//        broadcastScore(false);
//        Log.d("MainActivity","broadcastScore");
//        switchToScreen(R.id.screen_game);
//        Log.d("MainActivity","switchToScreen()");
//        findViewById(R.id.button_click_me).setVisibility(View.VISIBLE);
//
